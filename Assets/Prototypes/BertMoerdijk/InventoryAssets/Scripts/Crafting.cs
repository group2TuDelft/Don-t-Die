...
public class Crafting : MonoBehaviour {
    ...
    public void ActivateFurnaceAndAnvil()
    {
        if (FurnaceAndAnvil.activeSelf)
        {
            FurnaceAndAnvil.SetActive(false);
        }
        else
        {
            FurnaceAndAnvil.SetActive(true);
        }
    }
    public void ActivateFactoryChainBelt()
    {
        if (FactoryChainBelt.activeSelf)
        {
            FactoryChainBelt.SetActive(false);
        }
        else
        {
            FactoryChainBelt.SetActive(true);
        }
    }
    public void ActivateThreeDPrinter()
    {
        if (ThreeDPrinter.activeSelf)
        {
            ThreeDPrinter.SetActive(false);
        }
        else
        {
            ThreeDPrinter.SetActive(true);
        }
    }
    public void ActivateWeirdAlienMachine()
    {
        if (WeirdAlienMachine.activeSelf)
        {
            WeirdAlienMachine.SetActive(false);
        }
        else
        {
            WeirdAlienMachine.SetActive(true);
        }
    }
