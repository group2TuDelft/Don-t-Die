...
public class Objects
{
    ...
    public bool SpreadObjects(Vector3 positionObject, float radiusSameLayer, float radiusOtherLayers , int layer)
    {
        ...
        collidersOtherLayers = Physics.OverlapSphere(new Vector3(positionObject.x, positionObject.y, positionObject.z), radiusOtherLayers, ~(1 << 10) & ~(1<<layer));
    ...
    /*public float CalculateHeightObject(float randomX, float randomZ)
    {
        RaycastHit hit;
        Vector3 coordinates = new Vector3(randomX, 1000, randomZ);
