...
public class PlayerAnimator : MonoBehaviour {
    ...
    void setWeaponAnimation() {
        ...
        if (currentweapon == "Bow" || currentweapon == "catapult")
        {
            anim.SetBool("AnimHasBow", true);
        }
        if (currentweapon == "CrossBow" || currentweapon == "M1911" || currentweapon == "scifihandgun")
        {
            anim.SetBool("AnimHasHandgun", true);
        }
        if (currentweapon == "BlunderBuss" || currentweapon == "shotgun" || currentweapon == "scifibiggun")
        {
            anim.SetBool("AnimHasGun", true);
        }
        if (currentweapon == "axe")
        {
            anim.SetBool("AnimHasSlash", true);
        }
    }
