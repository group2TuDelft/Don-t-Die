...
namespace Crosstales.OIL.Demo.Util
{
    ...
    public class PlatformController : MonoBehaviour
    {
        ...
        public void Start()
        {
            if (OIL.Util.Helper.isWindowsPlatform)
            {
                currentPlatform = Platform.Windows;
            }
            else if (OIL.Util.Helper.isMacOSPlatform)
            {
                currentPlatform = Platform.OSX;
            }
            else if (OIL.Util.Helper.isAndroidPlatform)
            {
                currentPlatform = Platform.Android;
            }
            else if (OIL.Util.Helper.isIOSPlatform)
            {
                currentPlatform = Platform.IOS;
            }
            else if (OIL.Util.Helper.isWSAPlatform)
            {
                currentPlatform = Platform.WSA;
            }
            else if (OIL.Util.Helper.isWebGLPlatform)
            {
